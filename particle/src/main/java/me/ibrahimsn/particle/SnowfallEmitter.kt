...
class SnowfallEmitter : IEmitter {
    private companion object {
        private const val ALPHA_MIN = 180
        private const val ALPHA_MAX = 255
        private const val VX_MIN = -2
        private const val VX_MAX = 2
        private const val VY_MIN = 1
        private const val VY_MAX = 4
        private const val LINE_DIST_MAX = 150
        ...
        repeat(particleCount) {
            particles.add(
                Particle(
                    ...
                    x = Random.nextInt(0, width).toFloat(), // 随机水平位置
                    y = Random.nextInt(0, height / 4).toFloat(), // 屏幕顶部的随机位置
